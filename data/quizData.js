...
const quizData = {
    Introduction: [
      {
        id: 1,
        question: 'What are some benefits associated with Artificial Intelligence?',
        options: [
        ...
        correctAnswer: 'Potential to solve global challenges and accelerate scientific research',
      },
      {
        id: 2,
        question: 'Which three main fields have contributed to the development of Artificial Intelligence (AI)?',
        options: [
    ...
    'Intelligent-Agents': [
        {
          id: 1,
          question: 'What is the central concept identified in Chapter 2 for approaching artificial intelligence?',
          options: [
            'Increased job displacement and unemployment',
        ...
        {
          id: 2,
          question: 'According to Chapter 2, what is consequentialism in the context of artificial intelligence?',
          options: [
        ...
        {
          id: 3,
          question: 'In Chapter 2.3, what framework is introduced for specifying task environments?',
          options: [
